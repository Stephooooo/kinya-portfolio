...
function Home() {
  ...
  <div className='pt-10 pb-10 bg-gradient-to-tl from-sky-400 to-sky-200 rounded-md '>
  <h1 className='font-extrabold text-black text-[40px] mb-5'> Hello I'm Kinya, <br/> nice to meet you</h1>
    <h1 className='text-black  text-[20px] place-content-center pl-20 pr-20 mb-5 text-justify'> I am a passionate lady with a business-minded acumen aiming to learn, grow and
    contribute to the well-being of the society and community at large. </h1>
    <h1 className='text-black  text-[20px] place-content-center pl-20 pr-20 mb-10 text-justify'> 
...
<p className=' text-black text-[20px] mt-5 text-justify'> My main duties were: Daily customer service through correspondence and handling of walk-in clients, Conducting client interviews and account analysis of potential loan
...
<a
className= 'text-sky-600 text-[20px] font-bold border-2 border-sky-600 px-2 py-1 rounded-md '
